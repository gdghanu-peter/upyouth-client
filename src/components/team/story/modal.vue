      ...
      >
        <template #header>
          <div class="flex items-center justify-between">
            ...
            >
            From MIT to Vietnam. We build a future for young founders.
            </h3>
            <UButton
              color="gray"
              variant="ghost"
